...
#
#     PHX_SERVER=true bin/neko start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :neko, NekoWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :neko, Neko.Repo,
    ssl: [cacertfile: Application.app_dir(:neko, "priv/certs/bbtogether-db-ca.crt")],
    url: database_url,
  ...
  config :neko, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
